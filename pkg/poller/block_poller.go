...
func New(client *rpc.Client, interval time.Duration) *BlockPoller {
	return &BlockPoller{
		client:   client,
		interval: interval,
	}
...
func (ebp *BlockPoller) Poll(ctx context.Context, outCh chan string, errCh chan error) {
...
func (ebp *BlockPoller) getNewBlocks(ctx context.Context, latestBlockHex string) ([]string, error) {
